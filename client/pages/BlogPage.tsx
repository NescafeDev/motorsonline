...
export default function BlogPage() {
  ...
  return (
    <PageContainer className="font-poppins">
          ...
          <aside className="w-full lg:w-[240px] flex-shrink-0">
            <div className="space-y-6">
              ...
              <div className="space-y-0">
                <div className="bg-motor-gray-bg rounded-[10px] p-4 hover:bg-gray-50 hover:text-white transition-colors">
      ...
      {/* Newsletter Section */}
      <section className="w-full bg-motor-gray-bg py-16 bg-gray-50 mb-20">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full lg:w-[480px] space-y-4">
              <div className="flex gap-4">
                ...
                <button
                  type="submit"
                  className="px-8 py-4 bg-brand-primary hover:bg-brand-600 transition-colors rounded-[10px] text-white text-base font-normal flex items-center justify-center"
                >
                  Telli
                </button>
              </div>
        ...
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((index) => (
              ...
              >
                <img
                  src={`https://cdn.builder.io/api/v1/image/assets/TEMP/${index === 1
