...
export const translateCarDetail = (value: string, currentLanguage: string): string => {
  ...
  const translations: Record<string, Record<string, string>> = {
    ...
    'elektri': { en: 'Electric', ru: 'Электрический', de: 'Elektrisch', fi: 'Sähkö', et: 'Elektri' },
    ...
    'Adaptiivne Kruiiskontroll': { en: 'Adaptive Cruise Control', ru: 'Адаптивный круиз-контроль', de: 'Adaptive Geschwindigkeitsregelung', fi: 'Adaptiivinen vakionopeudensäädin', et: 'Adaptiivne Kruiiskontroll' },
